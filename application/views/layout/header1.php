    ...
    <div class="wrapper">
        <header class="main-header" id="alert">
            <!-- <a href="<?php //echo base_url();    ?>admin/admin/dashboard" class="logo">
                ...
                <span class="logo-lg">
                    <img src="<?php //echo base_url();    ?>backend/images/s_logo.svg" alt="<?php //echo $this->customlib->getAppName()    ?>" /></span>
            </a> -->
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) { ?>
                                                    <li style="display:none" class="<?php echo set_Submenu('timetable/index'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/timetable"><i
                                                ...
                                                if ($this->rbac->hasPrivilege('timetable_new', 'can_view')) { ?>
                                                    <li style="display:none"
                                                        class="<?php echo set_Submenu('timetablenew/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/timetablenew"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('promote_student', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('stdtransfer/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/stdtransfer"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('subject/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/subject"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('subject/subjecthours'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/subject/subjecthours"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            Subject Hours</a></li>
                                                    <?php
                                                }
                                                ...
                                                if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('subject/combinedsubject'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/subject/combinedSubject"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('class', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('classes/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>classes"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('section', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('sections/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>sections"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('weekly_calendar', 'can_view')) {
                                                    ?>
                                                    <li style="display:none"
                                                        class="<?php echo set_Submenu('weeklycalendar/index'); ?>"><a
                            ...
                            Log</a></li> -->
                                                ...
                                                if ($this->rbac->hasPrivilege('work_log', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('worklog_report/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/worklogreport"><i
                                                                class="fa fa-angle-double-right"></i>
                            ...
                            Monthly Report</a></li> -->
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('master_rotation_plan', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('master_rotation_plan/itemindex'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/masterrotation/itemindex"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('master_rotation_plan', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('masterrotation/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/masterrotation/index"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('monthly_academic_report', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('monthly_academic_report/monthlyperiodreport'); ?>">
                                                        <a
                                                            href="<?php echo base_url(); ?>admin/monthlyacademicreport/monthlyattendancereport"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('monthly_academic_report', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('subject/academicDate'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/subject/academicDate"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            Academic Date</a></li>
                                                <?php }
                                                ?>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('exam', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('exam/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/exam"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('exam_schedule', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('examschedule/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/examschedule"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('marks_register', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('mark/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/mark"><i
                                                                class="fa fa-angle-double-right"></i>
...
/*
                                                ...
                                                if ($this->rbac->hasPrivilege('transcript', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('transcript/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/transcript"><i
                                                                class="fa fa-angle-double-right"></i>
                            ...
                            if ($this->module_lib->hasActive('Internalmarks')) {
                                if (($this->rbac->hasPrivilege('Internalmarks', 'can_view')) || ($this->rbac->hasPrivilege('student_assignments', 'can_view'))) {
                                    ?>
                                    <!--        <div class="menu-card-col <?php echo set_Topmenu('Internalmarks'); ?>">-->
                                    ...
                                    <!--                </a>-->
                                    <!--                <ul class="dropdown-menu" aria-labelledby="dLabel">-->
                                    <!--                <?php if ($this->rbac->hasPrivilege('internal_mark_items', 'can_view')) { ?>-->
                                        <!--            <li class="<?php echo set_Submenu('Internalmarks/internalmarkitems'); ?>"><a href="<?php echo base_url(); ?>admin/Internalmark"><i-->
                                        <!--                        class="fa fa-angle-double-right"></i>-->
                                        <!--                    Internal Mark Items</a></li>-->
                                        <!--        <?php } ?>-->
                                    <!--        <?php if ($this->rbac->hasPrivilege('internal_mark_items', 'can_view')) { ?>-->
                                        <!--<li class="<?php echo set_Submenu('Internalmarks/assigninternalmarkitems'); ?>"><a href="<?php echo base_url(); ?>admin/Internalmark/assignItemsToSections"><i-->
                                        <!--            class="fa fa-angle-double-right"></i>-->
                                        <!--        Assign Internal Mark Items</a></li>-->
                                        <!--<?php } ?>-->
                                    <!--<?php if ($this->rbac->hasPrivilege('student_assignments', 'can_view')) { ?>-->
                                        <!--<li class="<?php echo set_Submenu('Internalmarks/studentSubmissions'); ?>"><a href="<?php echo base_url(); ?>admin/Internalmark/studentSubmissions"><i-->
                                        <!--            class="fa fa-angle-double-right"></i>-->
                                        <!--        Student Submissions</a></li>-->
                                        <!--<?php } ?>-->
                                    <!--<?php if ($this->rbac->hasPrivilege('student_assignments', 'can_view')) { ?>-->
                                        <!--<li class="<?php echo set_Submenu('Internalmarks/studentlist'); ?>"><a href="<?php echo base_url(); ?>admin/Internalmark/studentlist"><i-->
                                        <!--            class="fa fa-angle-double-right"></i>-->
                                        <!--        Student List</a></li>-->
                                        <!--<?php } ?>-->
                                    <!--<?php if ($this->rbac->hasPrivilege('student_assignments', 'can_view')) { ?>-->
                                        <!--<li class="<?php echo set_Submenu('Internalmarks/studentReport'); ?>"><a href="<?php echo base_url(); ?>admin/Internalmark/studentReport"><i-->
                                        <!--            class="fa fa-angle-double-right"></i>-->
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('clinical_locations', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('clinical_rotation/clinical_locations'); ?>">
                                                        <a
                                                            href="<?php echo base_url(); ?>admin/clinical_department/clinical_locations"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('viewassign_ward', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('clinical_rotation/clinical_department'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/clinical_department"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('warddetail', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('clinical_rotation/warddetail'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/Warddetail"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            Ward Details</a></li>
                                                <?php } ?>
                                                <?php if ($this->rbac->hasPrivilege('master_rotation_plan', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('masterrotation/clinicalrotation'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/masterrotation/clinicalrotation"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('clinical_report', 'can_view')) { ?>
                                                    <li style="display:none"
                                                        class="<?php echo set_Submenu('clinical_rotation/clinical_report'); ?>"><a
                                                ...
                                                if ($this->rbac->hasPrivilege('clinical_reportapprove', 'can_view')) {
                                                    ...
                                                    <li style="display:none"
                                                        class="<?php echo set_Submenu('admin/staffevaluation/clinicalReportApprove'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('hodviewclinical_report', 'can_view')) {
                                                    ?>
                                                    <li style="display:none"
                                                        class="<?php echo set_Submenu('admin/staffevaluation/hodclinicalReportview'); ?>">
                                                        <a
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('clinical_attendance', 'can_view')) { ?>
                                                    ...
                                                    <!--<li class="<?php echo set_Submenu('clinical_rotation/clinical_attendance_report'); ?>"><a-->
                                                    <!--href="<?php echo base_url(); ?>admin/clinical_department/clinical_attendance_report"><i-->
                                                    <!--    class="fa fa-angle-double-right"></i>-->
                                                    <!--<?php echo 'Clinical Attendance Report'; ?> </a></li>-->
                                                <?php } ?>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('staff', 'can_see_other_users_profile')) { ?>
                                                    <li class="<?php echo set_Submenu('admin/staff'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/staff"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('staff_attendance_report', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffattendance/attendancereport'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/staffattendance/attendancereport"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo $this->lang->line('staff_attendance_report'); ?>
                                                        </a>
                                                    </li>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffattendance/attendancereportbyperiod'); ?>">
                                                        <a
                                                            href="<?php echo base_url(); ?>admin/staffattendance/attendancereportbyperiod"><i
                                                                class="fa fa-angle-double-right"></i> Attendance Report By
                                                            Period</a>
                                                    </li>
                                                    <?php
                                                }
                                                if ($this->rbac->hasPrivilege('staff_payroll', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/payroll'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/payroll"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('approve_leave_by_class_coordinator', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('admin/leaverequest/leaverequestcc'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/leaverequest/leaverequestcc"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo $this->lang->line('approve_leave_request'); ?> Class Coordinator
                                                        </a></li>
                                                    <?php
                                                }
                                                ...
                                                if ($this->rbac->hasPrivilege('approve_leave_requestpr', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('admin/leaverequest/leaverequestprincipal'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/leaverequest/leaverequestprincipal"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('approve_leave_request_ug/pg', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('admin/leaverequest/leaverequestugpg'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/leaverequest/leaverequestugpg"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo $this->lang->line('approve_leave_request'); ?> UG/PG Coordinator
                                                        </a></li>
                                                    <?php
                                                }
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('student', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('student/search'); ?>"><a
                                                            href="<?php echo base_url(); ?>student/search"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('student', 'can_add')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('student/create'); ?>"><a
                                                            href="<?php echo base_url(); ?>student/create"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('parent_feedback', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('student/feedreport'); ?>"><a
                                                            href="<?php echo base_url(); ?>student/feedreport"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('update_kuhs', 'can_add')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('student/update_kuhs'); ?>"><a
                                                            href="<?php echo base_url(); ?>student/kuhs"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('student_categories', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('category/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>category"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('student_houses', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/schoolhouse'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/schoolhouse"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('collect_fees', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('studentfee/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>studentfee"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_master', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/feemaster'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/feemaster"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_group', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/feegroup'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/feegroup"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_type', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('feetype/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/feetype"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_discount', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/feediscount'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/feediscount"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_year', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('feeyear/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/feeyear"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_carry_forward', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('feesforward/index'); ?>"><a
                                                            href="<?php echo base_url('admin/feesforward'); ?>"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('virtual_account', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('virtual_account/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>virtualaccount"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('upload', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('upload'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/upload"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('file_reader', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('file_reader'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/file_reader"><i
                                                                class="fa fa-angle-double-right"></i>
                            ...
                            if ($this->module_lib->hasActive('front_office')) {
                                if (
                                    ...
                                    <div class="menu-card-col <?php echo set_Topmenu('front_office'); ?>">
                                        ...
                                        <div class="dropdown">
                                            <a id="dLabel" data-target="#" href="#" data-toggle="dropdown" role="button"
                                                aria-haspopup="true" aria-expanded="false" class="streached-link">
                                                Front Office
                                                <span class="caret"></span>
                                            </a>
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('admission_enquiry', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/enquiry'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/enquiry"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('visitor_book', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/visitors'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/visitors"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('device_type', 'can_view')) {
                                                    ...
                                                    <li style="display:none" class="<?php echo set_Submenu('admin/devicetype'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/devicetype"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('parts_change', 'can_view')) {
                                                    ...
                                                    <li style="display:none" class="<?php echo set_Submenu('admin/partchange'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/partchange"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('phone_call_log', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/generalcall'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/generalcall"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('postal_dispatch', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/dispatch'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/dispatch"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('postal_receive', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/receive'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/receive"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('complaint', 'can_view')) {
                                                    ...
                                                    <li style="display:none" class="<?php echo set_Submenu('admin/complaint'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/complaint"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('minutes_detail', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('minutes/minutes_details'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/minutes"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('centre', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('centre/centre_detail'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/centre"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('collect_fees', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('mess fee/collect fee'); ?>"><a
                                                            href="<?php echo base_url(); ?>studentmessfee"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo $this->lang->line('collect_fees'); ?>
                                                        </a></li>
                                                ...
                                                if ($this->rbac->hasPrivilege('fees_master', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('mess fee/mess fee master'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/messfeemaster"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo $this->lang->line('fees_master'); ?>
                                                        </a></li>
                                                <?php } ?>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('income', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('mess fee/income'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/mess_income"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <!-- <li class="<?php //echo set_Submenu('mess fee/search due fee');    ?>"><a href="<?php //echo base_url();    ?>studentmessfee/feesearch"><i class="fa fa-angle-double-right"></i> <?php //echo $this->lang->line('search_due_fees');    ?></a></li>-->
                                                <?php //}    ?>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('ledger', 'can_view')) { ?>
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/ledger'); ?>"><a
                                                            href="<?php echo base_url(); ?>accounts/ledger"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo 'Ledger'; ?>
                                                        </a></li>
                                                ...
                                                if ($this->rbac->hasPrivilege('journal', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('admin/journal'); ?>"><a
                                                            href="<?php echo base_url(); ?>accounts/journal"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo "Journal" ?>
                                                        </a></li>
                                                ...
                                                */
                                                ...
                                                if ($this->rbac->hasPrivilege('trial', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/trial'); ?>"><a
                                                            href="<?php echo base_url(); ?>accounts/trial"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('p&l_account', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/p&l_account'); ?>"><a
                                                            href="<?php echo base_url(); ?>accounts/profitandloss"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('balance_sheet', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/balance_sheet'); ?>"><a
                                                            href="<?php echo base_url(); ?>accounts/balancesheet"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('logs', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('admin/logs'); ?>"><a
                                                            href="<?php echo base_url(); ?>accounts/accountlogs"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('expense_head', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('expenseshead/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/expensehead"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('live_class', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('live_class/live_class'); ?>"><a
                                                            href="<?php echo base_url() ?>admin/live_class"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('mark_attendance', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('groupwise_attendance/mark_attendance'); ?>">
                                                        <a href="<?php echo base_url() ?>admin/clinical_department/mark_attendance"><i
                                                                class="fa fa-angle-double-right"></i>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('classroom_teaching_scores', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/teachinglectures'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/staffevaluation/teachinglectures"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('classroom_teaching_lectures_scores', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/teachinglecturesscore'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('Dental_clinic_based', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/dentalclinicbased'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/staffevaluation/dentalclinicbased"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('Dental_clinic_based_scores', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/dentalclinicbasedscore'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('patient_care_scores ', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/patientcarescore'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/staffevaluation/patientcarescore"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('departmental_schedule_development', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/scheduledevelopment'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('Departmental_schedule_scores', 'can_view')) {
                                                    ?>
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/scheduledevelopmentscore'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('research_supervision', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/researchsupervision'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('research_supervision_scores ', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/researchsupervisionscore'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('staff_reportapprove', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/staffReportApprove'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/staffevaluation/staffReportApprove"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('participation_in_faculty ', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/participationfaculty'); ?>">
                                                        <a
                                                ...
                                                if ($this->rbac->hasPrivilege('participation_in_faculty_scores ', 'can_view')) {
                                                    ...
                                                    <li
                                                        class="<?php echo set_Submenu('admin/staffevaluation/participationfacultyscore'); ?>">
                                                        <a
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('notice_board', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('notification/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/notification"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('upload_content', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('admin/content'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/content"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <li class="<?php echo set_Submenu('content/other'); ?>"><a
                                                        href="<?php echo base_url(); ?>admin/content/other"><i
                                                            class="fa fa-angle-double-right"></i>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('homework', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('homework'); ?>"><a
                                                            href="<?php echo base_url(); ?>homework"><i
                                                                class="fa fa-angle-double-right"></i>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('library_web', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('library/Library_web'); ?>"><a
                                                            href="https://pcd.libsoft.org/"><i class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('routes', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('route/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/route"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('vehicle', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('vehicle/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/vehicle"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('vehicle', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('vehicle/driver'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/vehicle/driver"><i
                                                                class="fa fa-angle-double-right"></i>
                                                            <?php echo "Driver"; ?>
                                                        </a></li>
                                                    <?php
                                                ...
                                                if ($this->rbac->hasPrivilege('assign_vehicle', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('vehroute/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/vehroute"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('assign_student', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('vehroute/assign_students'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/vehicle/assign_students"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('transport_report', 'can_view')) {
                                                    ?>
                                                    <li class="<?php echo set_Submenu('vehroute/transport_report'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/vehicle/transport_report"><i
                                                                class="fa fa-angle-double-right"></i>
...
/*
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('hostel_rooms', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('hostelroom/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/hostelroom"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('room_type', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('roomtype/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/roomtype"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('hostel', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('hostel/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/hostel"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('student_hostel_report', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/hostelroom/studenthosteldetails'); ?>">
                                                        <a href="<?php echo base_url(); ?>admin/hostelroom/studenthosteldetails"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('event', 'can_view')) { ?>
                                                    <li class="<?php echo set_Submenu('admin/front/events'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/events"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('gallery', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/front/gallery'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/gallery"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('notice', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/front/notice'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/notice"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('media_manager', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/front/media'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/media"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('pages', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/front/page'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/page"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('menus', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/front/menus'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/menus"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('banner_images', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/front/banner'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/front/banner"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                <?php if ($this->rbac->hasPrivilege('fees_report', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('Reports/feesreport'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/fees_report"><i
                                                                class="fa fa-angle-double-right"></i>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dLabel">
                                                ...
                                                if ($this->rbac->hasPrivilege('session_setting', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('sessions/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>sessions"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('financial_year', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('financial_year'); ?>"><a
                                                            href="<?php echo base_url(); ?>financial_year"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('starting_invoice', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('starting_invoice'); ?>"><a
                                                            href="<?php echo base_url(); ?>invoice"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('sms_setting', 'can_edit')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('smsconfig/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>smsconfig"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('email_setting', 'can_edit')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('emailconfig/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>emailconfig"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->module_lib->hasActive('front_cms')) {
                                                    if ($this->rbac->hasPrivilege('front_cms_setting', 'can_edit')) {
                                                        ...
                                                        <li class="<?php echo set_Submenu('admin/frontcms/index'); ?>"><a
                                                                href="<?php echo base_url(); ?>admin/frontcms"><i
                                                                    class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('superadmin')) { ?>
                                                    <li class="<?php echo set_Submenu('admin/roles'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/roles"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('backup', 'can_view')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('admin/backup'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/admin/backup"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('languages', 'can_add')) {
                                                    ...
                                                    <li class="<?php echo set_Submenu('language/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/language"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                <?php if ($this->rbac->hasPrivilege('user_status')) { ?>
                                                    <li class="<?php echo set_Submenu('users/index'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/users"><i
                                                                class="fa fa-angle-double-right"></i>
                                                ...
                                                if ($this->rbac->hasPrivilege('superadmin')) { ?>
                                                    <li class="<?php echo set_Submenu('admin/module'); ?>"><a
                                                            href="<?php echo base_url(); ?>admin/module"><i
                                                                class="fa fa-angle-double-right"></i>
                ...
                <div class="col-md-7 col-sm-9 col-xs-7 pull-right">
                    ...
                    <div class="pull-right">
                        ...
                        <form class="navbar-form navbar-left search-form" role="search" id="institution-form"
                            action="<?php echo site_url('schsettings/set_session'); ?>" method="POST">
                            ...
                            <div class="input-group" style="padding-top:3px;width: 191px;">
                                <select autofocus id="institution" name="institution"
                                    class="form-control search-form search-form3" style="border-radius: 13px;">
                                    <option value="">
                        ...
                        <form class="navbar-form navbar-left search-form" role="search" id="session-from"
                            action="<?php echo site_url('schsettings/header_session'); ?>" method="POST">
                            ...
                            <input type="hidden" name="currentid" id="currentid"
                                value="<?php echo $this->setting_model->getcurrentid(); ?>" />
                            <div class="input-group" style="padding-top:3px;width:102px;">
                                <select autofocus id="session" name="session"
                                            ...
                                            <div class="sstopuser">
                                                ...
                                                <div class="sspass">
                                                    ...
                                                    <a class="pl25"
                                                        ...
                                                        data-toggle="tooltip" title=""
                                                        data-original-title="Change Password"><i class="fa fa-key"></i>
