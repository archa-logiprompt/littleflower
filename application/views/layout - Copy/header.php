                           ...
                           href="<?php //echo base_url(); ?>admin/worklog"><i class="fa fa-angle-double-right"></i> Work
                            ...
                            <?php }
                             ?>
                              <?php if ($this->rbac->hasPrivilege('monthly_academic_report', 'can_view')) {
                                            ?>
                    <li class="<?php echo set_Submenu('monthly_academic_report/attendancereport'); ?>"><a
                            href="<?php echo base_url(); ?>admin/monthlyacademicreport/attendancereport"><i class="fa fa-angle-double-right"></i>
                            ...
                            if ($this->rbac->hasPrivilege('item_category', 'can_view')) {
                                ...
                                <li class="<?php echo set_Submenu('itemcategory/index'); ?>"><a
                                        href="<?php echo base_url(); ?>admin/itemcategory"><i
                                            class="fa fa-angle-double-right"></i><?php echo ('Category'); ?></a>
                                </li>
                                <?php
                            }
...
<li class="<?php echo set_Submenu('admin/p&l_account'); ?>"><a href="<?php echo base_url(); ?>accounts/profitandloss"><i class="fa fa-angle-double-right"></i>
        <?php echo "Profit & Loss Account"; ?></a></li>
