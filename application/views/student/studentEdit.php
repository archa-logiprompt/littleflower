                            ...
                            <div class="tshadow mb25 bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">KNMC Register Number</label>
                                                <input id="knmc" name="knmc" placeholder="" type="text" class="form-control" value="<?php echo $knmc; ?>" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <span class="text-danger"><?php //echo form_error('kuhs_reg'); 
                                                                        ?></span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="scholarship" name="scholarship" class="form-control">
                                                ...
                                                <?php if (!empty($sch)) foreach ($sch as $scholar) { ?>
                                                    <option <?php if ($scholar['id'] == $student['scholarship']) {
                                                                echo 'selected=selected';
                                                            } ?>value="<?php echo $scholar['id'] ?>"><?php echo $scholar['name'] ?></option>
                                                <?php  } ?>
