...
<div class="content-wrapper" style="min-height: 946px;">  
    ...
    <?php 
    echo (isset($subject['theory']) && $subject['theory'] !== '' ? $subject['theory'] : ' ') . 
         " " . 
         (isset($subject['practical']) && $subject['practical'] !== '' ? $subject['practical'] : ' ') . 
         " " . 
         (isset($subject['lab']) && $subject['lab'] !== '' ? $subject['lab'] : ' ') . 
         " " . 
         (isset($subject['clinical']) && $subject['clinical'] !== '' ? $subject['clinical'] : ' ');
    ?>
</td>
