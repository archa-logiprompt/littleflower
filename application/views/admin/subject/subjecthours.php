                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    ...
                                    <th>Course Code</th>
                                    <th>Subject Title</th>
                                    <th style="position: relative;"><label class="vertical-table-text bold">Theory Credits</label></th>
                                    <th style="position: relative;"><label class="vertical-table-text bold">Theory contact hours</label></th>
                                    <th><label class="vertical-table-text bold">Lab/Skill Lab Credits</label></th>
                                    <th><label class="vertical-table-text bold">Lab/Skill Lab Contact Hours</label></th>
                                    <th><label class="vertical-table-text bold">Clinical Credits</label></th>
                                    <th><label class="vertical-table-text bold">Clinical Contact Hours</label></th>
                                    <th><label class="vertical-table-text bold">Total Credits</label></th>
                                    <th><label class="vertical-table-text bold">Total Hours</label></th>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    ?>
                                            <tr>
                                                <?php if ($count == 0) { ?>
                                                    <td rowspan="<?php echo count($section['subject_hours']) ?>">
                                                        <label>
                                        ...
                                        <?php if ($theory_credits_sum != 0 && $theory_hours != 0 && $lab_credits != 0 && $lab_hours != 0 && $clinical_credits != 0 && $clinical_hours != 0) { ?>
                                            <tr class='totalrow'>
                                                ...
                                                <td class='bold' colspan='3' style="text-align: end;">Total</td>
