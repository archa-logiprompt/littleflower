        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if ($is_search) { ?>
                    <?php if (!$all_subject) { ?>
                        <div class="box box-primary">
                            <h3 class="titless pull-left"><i class="fa fa-money"></i> <?php echo 'Monthly Academic Report'; ?></h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <style>
                                            @media print {
                                                .table {
                                                    border-collapse: collapse !impotant;
                                                }
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($students as $key => $value) {
                                                        ...
                                                        $totalPracticalSubject = get_total_practical_attendence($value['id'], $class_id, $section_id, $subject_id, $date);

                                                        $total = get_monthly_student_attendance_total($value['id'], $class_id, $section_id, $subject_id, $date, 0);

                                                        $totalPractical = get_monthly_student_attendance_total_practical($value['id'], $class_id, $section_id, $subject_id, $date);
                                                        // var_dump($total);
                                                        $monthly_cm = get_monthly_student_attendance_cm($value['id'], $class_id, $section_id, $subject_id, $date, 0);
                                                        $monthlyPractical_cm = get_monthly_student_attendance_cm_practical($value['id'], $class_id, $section_id, $subject_id, $date);
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px; text-align:center"><?php echo ($monthlyPractical_pm) * 8 ?></td>
                                                            <td style="padding: 5px; text-align:center"><?php echo $monthlyPractical_cm * 8 ?></td>

                                                            <td style="padding: 5px; text-align:center"><?php echo $totalPractical * 8 ?></td>
                                                            <td style="padding: 5px; text-align:center">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php foreach ($subjects_teachers as $key => $value) {
                                                            $total = get_monthly_student_attendance_total($studentsvalue['id'], $class_id, $section_id, $value['id'], $date, 0);
                                                            //    var_dump($total);

                                                            $monthly_cm = get_monthly_student_attendance_cm($studentsvalue['id'], $class_id, $section_id, $value['id'], $date, 1);
