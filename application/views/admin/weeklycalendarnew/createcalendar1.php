                                            ...
                                            <form role="form" id="addcalendar_form" method="post"
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <!--  <select name="activity_id[]" id="activity_id"
                                                            class="form-control activityclass">
                                                        <option value="">Select</option>
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other">Other</option>
                                                        </select> -->
                                                        <select name="activity_id[]" id="activity_id" class="form-control activityclass" onchange="showTextBox(this)">
                                                            <option value="">Select</option>
                                                            <option value="Sports">Sports</option>
                                                            <option value="Acts">Acts</option>
                                                            <option value="Other" other="other1">Other</option>
                                                        </select>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            ...
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other1" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="Other" other="other2">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other2" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other3">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other3" >
                                                        </div>
                                                </div>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other4">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other4" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other5">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other5" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other6">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other6" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other7">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other7" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                            ...
                                            <form role="form" id="updatecalendar_form" method="post"
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other9">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other9" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other10">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other10" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other11">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other11" >
                                                        </div>
                                                </div>
                                                ...
                                                <div class="teacher-div">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other12">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other12" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other13">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other13" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other14">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other14" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
                                                    ...
                                                    <div class="form-group col-md-12" style="display:none">
                                                        ...
                                                        <option value="Sports">Sports</option>
                                                        <option value="Acts">Acts</option>
                                                        <option value="other" other="other15">Other</option>
                                                        </select>
                                                        <span
                                                            class="text-danger"><?php echo form_error('Activity'); ?></span>
                                                    ...
                                                    <div id="otherTextBox" style="display: none;" class="form-group col-md-12">
                                                            <label for="other_activity">Other Activity:</label>
                                                            <input type="text" name="other_activity" id="other-activity" class="form-control" other="other15" >
                                                        </div>
                                                </div>
                                                <div class="teacher-div">
                                                    <div class="form-group col-md-12 text-center">
