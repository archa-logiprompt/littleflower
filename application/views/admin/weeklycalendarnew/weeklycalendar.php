                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <h4> Week: <?php echo $dateStart.'-'.$dateEnd ?></h4>
                                                        ...
                                                        foreach ($week_name as $key => $value): ?>
                                                            <?php if ($weekcalendar[$key]['date'] != null) { ?>
                                                                <th style="padding: 5px;">
                                                                    <?php  
                                                                    $date=DateTime::createFromFormat('d/m/Y', $weekcalendar[$key]['date']);
                                                                    $date->format('d-m-Y');
                                                                    $dateFormatted = $date->format('d-m-Y');
                                                                    echo date('l',strtotime($dateFormatted)) . ' (' . $weekcalendar[$key]['date'] . ')';
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><?php echo "$period_list->period_one_from - $period_list->period_one_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
                                                    ...
                                                    <tr>
                                                         <td><?php echo "$period_list->period_two_from - $period_list->period_two_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
                                                    ...
                                                    <tr>
                                                        <td><?php echo "$period_list->period_three_from - $period_list->period_three_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
                                                    ...
                                                    <tr>
                                                        <td><?php echo "$period_list->period_four_from - $period_list->period_four_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
                                                    ...
                                                    <tr>
                                                        <td><?php echo "$period_list->period_five_from - $period_list->period_five_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
                                                    ...
                                                    <tr>
                                                        <td><?php echo "$period_list->period_six_from - $period_list->period_six_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
                                                    ...
                                                    <tr>
                                                        <td><?php echo "$period_list->period_seven_from - $period_list->period_seven_to" ?></td>
                                                        <td>
                                                            Subject
                                                            <br>
                                                            Faculty
