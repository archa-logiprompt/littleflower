...
<div class="content-wrapper" style="min-height: 946px;">  
    <section class="content-header">
        <h1>
            <i class="fa fa-mortar-board"></i> <?php echo "Ledgers"; ?></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="col-md-4">          
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?php echo "Add Ledger"; ?></h3>
                        </div>
                        
                        <form  action="<?php echo site_url('accounts/ledger/insert/'.$id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo "Ledger Name"; ?></label><small class="req"> *</small>
                                    <input autofocus="" id="subname" name="name" placeholder="" type="text" class="form-control"   value="<?php echo $item['ledger']; ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="subname" name="type" placeholder="" type="text"
                                        class="form-control">
                              ...
                              <!--  <label class="radio-inline">
                                ...
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1"><?php echo "Balance"; ?></label>
                                    <input id="subcode" name="balance" placeholder="" type="number" class="form-control"  value="<?php echo $item['balance']; ?>" />
            ...
            ?>">            
                <div class="box box-primary" id="sublist">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><?php echo "Ledger List"; ?></h3>
                    </div>
                    <div class="box-body">
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                ...
                                <tbody>
                                    ...
                                    foreach ($ledgers as $row) {
                                        ...
                                        <tr>
                                        <td class="mailbox-name"> <?php echo $count;$count++; ?></td>
                                            <td class="mailbox-name"> <?php echo $row['ledger'] ?></td>
                                            <td class="mailbox-name">
                                                <?php echo $row['name'] ?>
                                            </td>
                                            <td class="mailbox-name"><?php echo $row['balance'] ?></td>
