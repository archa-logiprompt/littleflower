        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>accounts/BalanceSheet/search" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
    ...
    <?php if ($type == 0) { ?>
        ...
        <section class="content">
            <div class="box box-primary" id="pdf">
                <button style="margin-right: 10px;margin-top: 10px;" name="search" id="collection_print" class="btn btn-sm btn-primary login-submit-cs fa fa-print pull-right">
                    <?php echo $this->lang->line('print'); ?></button>

                <div class="box-header with-border">
                    <h3>Caritas College of Nursing</h3>
                    <h4>Balance Sheet </h4>
                    <h4>for the year ending </h4>
                </div>
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $capital;
                                $lamount = $lamount + $capital; ?></td>
                        </tr>
                        <?php if ($profit_and_loss >= 0) {
                        ?>
                            <tr>
                                <td><?php echo $count;
                                    $count++; ?></td>
                                <td><?php echo "Net Profit" ?></td>
                                <td><?php echo $profit_and_loss->profit_loss;
                                    $lamount = $lamount + $profit_and_loss->profit_loss; ?></td>
                            </tr>
                        <?php } else { ?>
                            <tr>
                                <td><?php echo $count;
                        ...
                        foreach ($asset as $row) { ?>
                            <tr>
                                <td><?php echo $count;
                                    $count++; ?></td>
                                <td><?php echo $row['ledger'] ?></td>
                                <td><?php $balance = $row['debit'] - $row['credit'] + $row['balance'];
                                    echo $balance;
                                    $Aamount = $Aamount + $balance;
                                    ?></td>
