...
<div class="content-wrapper" style="min-height: 946px;">
    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <form id="assign_teacher_form" action="<?php echo base_url(); ?>accounts/accountlogs/modifiedentry/<?php echo $entry->id ?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="by" name="by[]" class="form-control" required>
                                            <option value="">
                                            ...
                                            ?>
                                                <option value="<?php echo $class['lid'] ?>" <?php echo $entry->debit == $class['lid'] ? "selected" : "" ?>>
                                            <?php echo $class['ledger'] ?>
                                        </option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="byamount" name="byamount[]" class="form-control" placeholder="Enter Amount" required />
                                        <span class="text-danger">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select autofocus="" id="to" name="to[]" class="form-control" required>
                                            <option value="">
                                                <?php echo $this->lang->line('select'); ?>
                                            </option>
                                            <?php
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="toamount" name="toamount[]" class="form-control" placeholder="Enter Amount" required />
                                        <span class="text-danger">
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-8">
                            ...
                            <textarea type="text" id="narration" name="narration" class="narration form-control" placeholder="Enter Narration" rows="4" required> </textarea>
