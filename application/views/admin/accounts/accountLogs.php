...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1><i class="fa fa-mortar-board"></i> <?php echo "Logs/History" ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>accounts/accountlogs/search" id="employeeform"
                        name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            <?php echo $this->customlib->getCSRF(); ?>


                            <div class="col-md-<?php if ($usertype == 'Super Admin') {
                                echo 4;
                            } else {
                                echo 6;
                            } ?>">
    ...
    <?php if (isset($log)) {
        ?>
        <div class="box box-primary">
            <h3 class="titless pull-left"><i class="fa fa-money"></i> <?php echo 'Logs'; ?>

            </h3>

            <button type="button" style="margin-right: 10px;margin-top: 10px;" name="search" id="collection_print" value=""
                        ...
                        <table style="width:100%;" border="1">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="padding: 5px;">Debit</th>
                                    <th style="padding: 5px;">Credit</th>
                                    <th style="padding: 5px;">Amount</th>
                                    <th style="padding: 5px;">Narration</th>
                            ...
                            <tbody>
                                ...
                                foreach ($log as $row) { ?>
                                    <tr>
                                        ...
                                        <td><?php $debit = json_decode($row['debit']);
                                        $c = 1;
                                        foreach ($debit as $id) {
                                            $debitName = getLedgerName($id);
                                            if (count($debit) == 1) {
                                                echo ($debitName);
                                            } else {
                                                if ($c != count($debit)) {
                                        ...
                                        <td><?php $credit = json_decode($row['credit']);
                                        foreach ($credit as $id) {
                                            $creditName = getLedgerName($id);
                                            echo ($creditName);
                                        }
                                        ?>
                                        </td>
                                        <td><?php $amount = json_decode($row['debit_amount']);
                                        $totalDebit = 0;
                                        $totalCredit = 0;
                                        foreach ($amount as $amt) {
                                            $totalDebit = $totalDebit + $amt;
                                        } ?>
                                            <?php $amount = json_decode($row['credit_amount']);
                                            foreach ($amount as $amt) {
                                        ...
                                        <td><a href="<?php echo base_url(); ?>accounts/accountlogs/edit/<?php echo $row['id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
                                                title="<?php echo $this->lang->line('edit'); ?>">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="<?php echo base_url(); ?>accounts/accountlogs/delete/<?php echo $row['id'] ?>"
                                                class="btn btn-default btn-xs" data-toggle="tooltip"
