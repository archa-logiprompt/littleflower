                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">
                                <?php echo "Add item Name"; ?>
                            </h3>
                        </div>
                        <form action="<?php echo site_url('accounts/stock/insert') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <input id="subcode" name="stock" placeholder="" type="number" class="form-control" value="<?php echo set_value('balance'); ?>" />
                                    <span class="text-danger">
                                </div>
                                </span>
