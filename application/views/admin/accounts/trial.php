        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form action="<?php echo base_url(); ?>accounts/Trial/search" id="employeeform" name="employeeform"
            ...
            <div class="row">
                ...
                <?php echo $this->lang->line('print'); ?></button>
                    <div class="box box-primary" id="collection_report">
                        ...
                        <div class="box-header with-border">
                            <h3>
                                <?php echo $this->setting_model->getCurrentSchoolName() . " <br>Trial Balance <br> For the Year Ending " . $year->financial_year; ?>
                            </h3>
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <tbody>
                                ...
                                $debit=0;
                                $credit=0;
                                foreach ($assetAndLiability as $ledger) {
                                    $total = $ledger['debit'] - $ledger['credit']+$ledger['previousBalance'];
                                    if ($total != 0) { ?>
                                        <tr>
                                            <td>
                                                <?php echo $count++ ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo "Profit and Loss"?></td>
                                    <?php if($profitAndLoss>=0){ ?>

                                        <td><?php  ?></td>
                                        <td><?php echo $profitAndLoss;
                                        $credit=$credit+abs($profitAndLoss); ?></td> 
                                        <?php
                                    } else{ ?>
                                        <td><?php echo $profitAndLoss;
                                         $debit=$debit+abs($profitAndLoss);
                                         ?></td> 
                                        <td><?php  ?></td>
                                   <?php  } ?>
                            ...
                            <?php } else if($type=="previous"){ ?>
                                ...
                                $credit=0;
                                foreach ($assetAndLiability as $ledger) { 
                                    $total = $ledger['previousBalance']+($ledger['debit']-$ledger['credit']);
                                    if ($total != 0) { ?>
                                        <tr>
                                            <td>
                                                <?php echo $count++ ?>
