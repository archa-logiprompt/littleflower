...
<div class="content-wrapper">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/exam"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo "Result Publishing Date" ?> </label><small class="req"> *</small>
                                    <input autofocus="" id="name" name="result_date" placeholder="" type="date" class="form-control"  value="<?php echo set_value('result_date'); ?>" />
    ...
    <?php echo date('d-m-Y', strtotime($exam['result_date'])); ?>
</a>
