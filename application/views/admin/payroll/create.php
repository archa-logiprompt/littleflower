        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                                    ...
                                    <div class="col-md-2">
                                        <div class="row">
                                            ...
                                            <img width="115" height="115" class="round5"
                                                src="<?php echo base_url() . "uploads/staff_images/" . $file ?>"
                                                alt="No Image">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <table class="table mb0 font13">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <?php echo $this->lang->line('epf_no'); ?>
                                                        </th>
                                                        <td>
                                                            <?php echo $result["epf_no"] ?>
                                                        </td>
                                                        <th>
                                    ...
                                    <div class="padd-en-rtl33">
                                        <table class="table mb0 font13">
                                            <tr>
                                                ...
                                                <?php foreach ($attendanceType as $key => $value) { ?>
                                                    <th class="bozero"><span data-toggle="tooltip"
                                                            title="<?php echo $value["type"]; ?>">
                                                            <?php echo strip_tags($value["key_value"]); ?>
                                                        </span></th>
                                                <?php }
                                                ?>

                                                <th class="bozero"><span data-toggle="tooltip"
                                                        title="<?php echo $this->lang->line('approved'); ?> <?php echo $this->lang->line('leave'); ?>">V</span>
                                                </th>
                                            </tr>
                                            <?php
                                            foreach ($monthAttendance as $attendence_key => $attendence_value) {
                                                ...
                                                <tr>
                                                    <td>
                                                        <?php echo date("F", strtotime($attendence_key)); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $attendence_value['present'] ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $attendence_value['late']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $attendence_value['absent']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $attendence_value['half_day']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $attendence_value['holiday']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo $monthLeaves[date("m", strtotime($attendence_key))]; ?>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
                    ...
                    <!-- /.box-body -->
                    <form class="form-horizontal" action="<?php echo site_url('admin/payroll/payslip') ?>" method="post"
                        id="employeeform">
                        <div class="box-header">
                            <div class="row display-flex">
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="sameheight">
                                        <div class="feebox">
                                            ...
                                            <tr id="row0">
                                                    <td><input type="text" class="form-control" id="allowance_type"
                                                            name="allowance_type[]" placeholder="Type" value="Salary Advance" readonly style="background-color:#fff"></td>
                                                    <td><input type="text" id="allowance_amount"
                                        ...
                                        <div class="feebox">
                                            <table class="table3" id="tableID2">
                                                ...
                                                <td><input type="text" id="deduction_type" name="deduction_type[]"
                                                            class="form-control" placeholder="Type" value="PF" readonly style="background-color:#fff"></td>
                                                    
                                                    <td><input type="text" id="deduction_amount"
                                                ...
                                                <tr id="deduction_row0">
                                                <td><input type="text" id="deduction_type" name="deduction_type[]"
                                                            class="form-control" placeholder="Type" value="ESI" readonly style="background-color:#fff"></td>
                                                    <td><input type="text" id="deduction_amount"
                                                            name="deduction_amount[]" class="form-control" value="0">
                                                    </td>
                                                ...
                                                <tr id="deduction_row0">
                                                <td><input type="text" id="deduction_type" name="deduction_type[]"
                                                            class="form-control" placeholder="Type" value="Salary Advance" readonly style="background-color:#fff"></td>
                                                    <td><input type="text" id="deduction_amount"
                                                            name="deduction_amount[]" class="form-control" value="0">
                                                    </td>
                                                ...
                                                <tr id="deduction_row0">
                                                <td><input type="text" id="deduction_type" name="deduction_type[]"
                                                            class="form-control" placeholder="Type" value="LOP" readonly style="background-color:#fff"></td>
                                                    <td><input type="text" id="deduction_amount"
                                                            name="deduction_amount[]" class="form-control" value="0">
                                                    </td>
                                                ...
                                                <tr id="deduction_row0">
                                                <td><input type="text" id="deduction_type" name="deduction_type[]"
                                                            class="form-control" placeholder="Type" value="Professional Tax" readonly style="background-color:#fff"></td>
                                                    <td><input type="text" id="deduction_amount"
                                                            name="deduction_amount[]" class="form-control" value="0">
                                                    </td>
                                                ...
                                                <tr id="deduction_row0">
                                                <td><input type="text" id="deduction_type" name="deduction_type[]"
                                                            class="form-control" placeholder="Type" value="TDS" readonly style="background-color:#fff"></td>
                                                    <td><input type="text" id="deduction_amount"
                                                            name="deduction_amount[]" class="form-control" value="0">
                                                    </td>
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="sameheight">
                                        <div class="payrollbox feebox">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">
                                                    <?php echo $this->lang->line('gross_salary'); ?>
                                                </label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 deductiondred">
                                                    <input class="form-control" name="tax" id="tax" value="0"
                                                        type="text" />
                                                </div>
                                            </div><!--./form-group-->
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <button type="submit" id="contact_submit" class="btn btn-info pull-right">
