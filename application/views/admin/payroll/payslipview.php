...
<head>
    ...
    <title>
        <?php echo $this->lang->line('payslip'); ?>
    </title>
</head>
            ...
            <div class="">
                <table width="100%">
                    <tr>
                        ...
                        <td align="center">
                            <div style="position: absolute;left:15px"><img
                                    src="<?php echo base_url() ?>/uploads/school_content/logo/<?php echo $settinglist["image"] ?>"
                                    style="width: 70px;height: 70px;" /></div>
                            <h1 style="margin: 0;">
                                <?php echo $settinglist["name"]; ?>
                            </h1>
                            <h5>
                                <?php echo $settinglist["address"] ?>
                                <?php echo $this->lang->line('phone'); ?>:
                                <?php echo $settinglist["phone"] ?>
                            </h5>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <h3 style="margin: 10px 0 20px;">
                                <?php echo $this->lang->line('payslip_for_the_period_of'); ?>
                ...
                <table width="100%" class="paytable2">
                    <tr>
                        ...
                        <th class="text-right">
                            ...
                            <?php echo date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($result['payment_date'])); ?>
                        </th>
                ...
                <table class="earntable table table-striped table-responsive">
                    <tr>
                        ...
                        <th width="16%" class="pttright reborder">
                            <?php echo $this->lang->line('amount'); ?>(
                            <?php echo $currency_symbol; ?>)
                        </th>
                        <th width="20%" class="pttleft">
                    ...
                    foreach ($allowance as $key => $value) {
                        ?>
                                <tr>
                                <td>
                                    <?php echo $positive_allowance[$j]["allowance_type"]; ?>
                                </td>
                                <td class="pttright reborder">
                                    <?php echo $positive_allowance[$j]["amount"]; ?>
                                </td>
                               
                                <td class="pttleft">
                                    <?php echo $negative_allowance[$j]["allowance_type"]; ?>
                                </td>
                                <td class="text-right">
                                    <?php echo $negative_allowance[$j]["amount"]; ?>
                                </td>
                                </tr>
                    ...
                    <tr>
                        ...
                        <th class="pttright reborder">
                            <?php echo $result["total_allowance"] ?>
                        </th>
                        <th class="pttleft">
                            <?php echo $this->lang->line('total'); ?>
                            <?php echo $this->lang->line('deduction'); ?>
                        ...
                        <th class="text-right">
                            <?php echo $result["total_deduction"] ?>
                        </th>
                    </tr>
                </table>
                ...
                <table class="totaltable table table-striped table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $result["basic"] + $result["total_allowance"] ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $result["net_salary"] ?>
                        </td>
                    </tr>

                </table>
                <p class="ptt10">
                    <?php echo $this->lang->line('computer_generated_payslip'); ?>
                </p>
            </div>
        </div>
        <!--/.col (left) -->
