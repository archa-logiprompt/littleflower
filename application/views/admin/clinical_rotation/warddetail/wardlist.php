...
<div class="content-wrapper">
    <section class="content-header">
        <h1><i class="fa fa-money"></i>
            <?php echo $this->lang->line('warddetail'); ?>
        </h1>
    </section>
                        ...
                        <form id="warddetail" action="<?php echo base_url() ?>admin/warddetail" name="warddetail"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select autofocus="" id="location_id" name="location_id" class="form-control">
                                        <option value="">
                                        ...
                                        foreach ($locations as $location) {
                                            ...
                                            <option value="<?php echo $location['id'] ?>" <?php
                                               if (set_value('location_id') == $location['id']) {
        ...
        <button class="btn btn-primary btn-sm" type="button" id="append"><i
                class="fa fa-plus"></i>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="text-danger">
                                        <?php echo form_error('name_department'); ?>
                                    </span>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">
                                        <?php echo $this->lang->line('landmark'); ?>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Ward contact</label>
                                    ...
                                    <span class="text-danger">
                                        <?php echo form_error('wardcontactdetails'); ?>
                                    </span>
                                </div>
                                    ...
                                    foreach ($warddetaillist as $warddetail) {
                                        ...
                                        <tr>
                                            <td class="mailbox-name">
                                                <?php echo $warddetail['deptname'] ?>
                                            </td>
                                            <td class="mailbox-name">
                                                <?php echo $warddetail['location'] ?>
                                            </td>
                                            <td class="mailbox-name">
                                                <?php echo $warddetail['aliasname'] ?>
                                            </td>

                                            <td class="mailbox-name">
                                                <?php echo $warddetail['block'] ?>
                                            </td>

                                            <td class="mailbox-name">
                                                <?php echo $warddetail['incharge'] ?>
                                            </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="transcript" style="margin-left: 34px; margin-right: 34px;">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="exampleInputEmail1" style="padding-left: 50px;">
                ...
                <div class="modal-footer">
                    <button id="btnsub" type="submit" class="allot-fees btn btn-info pull-right">
                        <?php echo $this->lang->line('save'); ?>
                    </button>
