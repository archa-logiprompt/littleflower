        ...
        <div class="row">   
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id='form1' action="<?php echo site_url('admin/clinical_department/clinical_attendance_report') ?>"  method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 group-col" style="display:none">
                                    <div class="form-group">
                ...
                <?php
                    ...
                    if(isset($resultlist)) {
						...
						if(!empty($checkres)){
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($resultlist as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                             echo showAttendanceType($value['attendance_type_id']);
                                                            ?>
                            ...
                            ?>
 <div class="alert alert-info">No Attendance Marked</div>
                            <?php } ?>
                        </div>
                    </div>
                        <?php
