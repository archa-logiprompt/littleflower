    ...
    foreach ($weekdata as $key => $value) {
        ?>
                                            ...
                                            <th id="week-id" class="weekno" data-id="" data-color=""
                                                data-week-no="<?php echo $count; ?>" colspan="2"><?php echo $count; ?></th>
                                            <?php
$count++;
    }?>
...
<body>
    ...
    <?php  foreach ($planwithday as $key => $value) { 
        ?>
        <tr style="height:25px; "><td><?php echo $value[0]?></td></tr>
        <?php 
        $count=1
    }
                                                    ?>
...
$(document).on('click', '#week-id', function(e) {
    ...
    var weekcount = <?php echo $weekcount*2;?>
    ...
    console.log(weekcount);
        ...
        $("td").eq(indexnumber-1).data('id', selectedplanid)
        $("td").eq(indexnumber-1).data('color', selectedplancolor)
        $("td").eq(indexnumber-1).css('backgroundColor', selectedplancolor);
    })
