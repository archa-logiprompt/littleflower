            ...
            <?php if ($this->rbac->hasPrivilege('driver', 'can_add')) { ?>
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/vehicle/driver') ?>" id="employeeform"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="driver_name" name="driver_name" placeholder="" type="text"
                                        class="form-control" value="<?php echo set_value('driver_name'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="licence_no" name="licence_no" placeholder="" type="text" class="form-control"
                                        value="<?php echo set_value('licence_no'); ?>" />
                                    <span class="text-danger">
