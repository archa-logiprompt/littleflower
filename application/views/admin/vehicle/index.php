                    ...
                    <div class="box box-primary" >
                        ...
                        <form id="form1" action="<?php echo site_url('admin/vehicle/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo "Number of Seats"; ?></label><small class="req"> *</small>
                                    <input autofocus="" id="seat" name="seat" placeholder="" type="text" class="form-control"  value="<?php echo set_value('seat'); ?>" />
                                    <span class="text-danger"><?php echo form_error('seat'); ?></span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <?php if (empty($listVehicle)) {
                                        ...
                                        foreach ($listVehicle as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-name"> <?php echo $data['seat'] ?></td>
