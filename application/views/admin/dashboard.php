                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <?php if ($classDiv) { ?>
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <h4 style="text-align:center"><strong>Today's Classes</strong></h4>
                                    <div>
                                        <?php $periods = array('First Hour', 'Second Hour', 'Third Hour', 'Fourth Hour', 'Fifth Hour', 'Sixth Hour', 'Seventh Hour', 'Eight Hour') ?>
