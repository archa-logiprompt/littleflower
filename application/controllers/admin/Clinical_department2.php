...
class Clinical_department extends Admin_Controller
{
    ...
    function clinical_attendance_report()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $hiddenSectionIds = [25, 26, 27, 28];

            if (in_array($sectionid, $hiddenSectionIds)) {

                $getstud = $this->clinicalrotation_model->getAllStudents($classid, $sectionid, $date, $subject_id);
